...
class CirclesDataset3D:
    """
    Dataset class for 3D Circles data.
    Creates two 3D circles in different planes for binary classification.
    """
    def __init__(self, num_points=200, test_size=0.2, batch_size=6, random_state=42):
        self.num_points = num_points
        self.test_size = test_size
        self.batch_size = batch_size
        self.random_state = random_state
        self.X, self.y = self._create_circles_dataset()
    ...
    def _create_circles_dataset(self):
...
class MNISTDataset:
    def __init__(self, test_size=0.2, batch_size=64, random_state=42):
        ...
        self.batch_size = batch_size
        self.random_state = random_state
        self.X, self.y = self._load_mnist()
    ...
    def visualize(self, samples=10):
        ...
        # Plot
        fig, axes = plt.subplots(1, samples, figsize=(samples*2, 3))
...
class XORDataset:
    ...
    """
    def __init__(self, batch_size=4, test_size=0.25, random_state=42):
        self.batch_size = batch_size
        self.test_size = test_size
        self.random_state = random_state
        self.X, self.y = self._create_xor_dataset()
